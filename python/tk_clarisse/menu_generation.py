...
class MenuGenerator(object):
    ...
    def _add_menu_item(self, name, parent_menu_name, callback):
        ...
        item = self._main_menu_handle.add_command_as_script("ScriptingPython", menu_item, 'ix.shotgun.menu_callbacks["%s"]()' % menu_item, "", menu_item)
...
class AppCommand(object):
    ...
    def add_command_to_menu(self, menu):
        ...
        self.parent._add_menu_item(parts[-1], parent_menu, self._execute_deferred)
