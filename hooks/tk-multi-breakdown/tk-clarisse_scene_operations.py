...
class BreakdownSceneOperations(Hook):
        ...
        for type_ in types:
            ...
            for object in objects:
                ...
                if attr:
                    ...
                    refs.append( {"attr": attr, "type": "file", "path": ref_path})
        return refs
    ...
    def update(self, items):
        ...
        the that each attribute should be updated *to* rather than the current path.
        """
        ...
        for i in items:
            ...
            if node_type == "file":
                engine.log_debug("File %s: Updating to version %s" % (attr, new_path))
